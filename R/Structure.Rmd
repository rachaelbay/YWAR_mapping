...
####Read in qmatrices
K2 <- read.delim("../structure_out/96snps_qmat/K2.txt",row.names=1,header=F)
K3 <- read.delim("../structure_out/96snps_qmat/K3.txt",row.names=1,header=F)
K4 <- read.delim("../structure_out/96snps_qmat/K4.txt",row.names=1,header=F)
K5 <- read.delim("../structure_out/96snps_qmat/K5.txt",row.names=1,header=F)
...
```{r shapefile,warnings=FALSE,message=F}
